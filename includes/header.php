  ...
  <nav class="sidebar">
    ...
    <ul class="nav-links">
      ...
      <li class="<?= $page === 'dashboard' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/dashboard.php"><i class="ico">▦</i> Dashboard</a>
      </li>
      ...
      <?php if (in_array($user['role'], ['Admin', 'Cashier', 'User'])): ?>
        ...
        <?php if (in_array($user['role'], ['Admin', 'Cashier'])): ?>
          <li class="<?= $page === 'cashier' ? 'active' : '' ?>">
            <a href="<?= APP_ROOT ?>/pages/cashier.php"><i class="ico">🛒</i> POS / Cashier</a>
          </li>
        <?php endif; ?>
        <li class="<?= $page === 'transactions' ? 'active' : '' ?>">
          <a href="<?= APP_ROOT ?>/pages/transactions.php"><i class="ico">📋</i> Transactions</a>
        </li>
      <?php endif; ?>

      <li class="nav-section">INVENTORY</li>
      <li class="<?= $page === 'products' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/pages/products.php"><i class="ico">📦</i> Products</a>
      </li>
      <li class="<?= $page === 'categories' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/pages/categories.php"><i class="ico">🗂</i> Categories</a>
      </li>
      <li class="<?= $page === 'stock' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/pages/stock.php"><i class="ico">📊</i> Stock</a>
      </li>

      <li class="nav-section">PROCUREMENT</li>
      <li class="<?= $page === 'suppliers' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/pages/suppliers.php"><i class="ico">🏭</i> Suppliers</a>
      </li>
      <li class="<?= $page === 'purchase_orders' ? 'active' : '' ?>">
        <a href="<?= APP_ROOT ?>/pages/purchase_orders.php"><i class="ico">📑</i> Purchase Orders</a>
      </li>

      <?php if ($user['role'] === 'Admin'): ?>
        <li class="nav-section">ADMIN</li>
        <li class="<?= $page === 'users' ? 'active' : '' ?>">
          <a href="<?= APP_ROOT ?>/pages/users.php"><i class="ico">👥</i> Users</a>
        </li>
        <li class="<?= $page === 'reports' ? 'active' : '' ?>">
          <a href="<?= APP_ROOT ?>/pages/reports.php"><i class="ico">📈</i> Reports</a>
        </li>
      <?php endif; ?>
    </ul>

    <div class="sidebar-footer">
      <a href="<?= APP_ROOT ?>/logout.php" class="logout-btn">⏏ Logout</a>
    </div>
  </nav>
