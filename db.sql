...
-- ============================================================
CREATE DATABASE IF NOT EXISTS TechParts2;
USE TechParts2;
-- -----------------------------------------------------------
-- 1. USERS
-- -----------------------------------------------------------
...
UPDATE User
SET password = '$2y$12$HkShLMTqlBnoxg69isYH0eL32R3a.0E9myWu/ZINJnHDIR/fAKCKS'
WHERE id = 2.;
...
('Admin User',       'admin@techparts.com',   '1111', 'Admin'),
('Juan Dela Cruz',   'juan@techparts.com',    '1111', 'Cashier'),
('Viewer Account',   'viewer@techparts.com',  '1111', 'Viewer'),
('Regular User',     'user@techparts.com',    '1111', 'User');
