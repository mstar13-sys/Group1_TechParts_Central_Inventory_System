...
$monthSales     = $db->query("SELECT COALESCE(SUM(TotalAmount),0) FROM Transaction WHERE MONTH(TransactionDate)=MONTH(CURDATE()) AND Status='Completed'")->fetchColumn();
$pendingPOs     = $db->query("SELECT COUNT(*) FROM PurchaseOrder WHERE Status IN ('Pending','Approved','Ordered')")->fetchColumn();
$lowStock       = $db->query('SELECT COUNT(*) FROM Stock WHERE Quantity <= MinStock AND Quantity > 0')->fetchColumn();
$outOfStock     = $db->query('SELECT COUNT(*) FROM Stock WHERE Quantity = 0')->fetchColumn();
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:20px">
  ...
  <div class="card">
    ...
    <div class="table-wrap">
      <table>
        <thead><tr><th>Customer</th><th>Amount</th><th>Method</th><th>Date</th><th>Status</th></tr></thead>
        <tbody>
        ...
        <tr>
          ...
          <td>
            <?php $sc = match($t['Status']){'Completed'=>'green','Voided'=>'red','Refunded'=>'yellow',default=>'gray'}; ?>
  ...
  <div class="card">
    ...
    <div class="table-wrap">
      <table>
        <thead><tr><th>Product</th><th>Brand</th><th>Sold</th><th>Revenue</th></tr></thead>
        <tbody>
...
<div class="card" style="margin-top:0">
  ...
  <div class="table-wrap">
    <table>
      <thead><tr><th>#</th><th>Supplier</th><th>Order Date</th><th>Arrival</th><th>Status</th></tr></thead>
      <tbody>
